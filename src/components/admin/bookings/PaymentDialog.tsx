            ...
            <Box>
              ...
              {selectedBooking && (
                <Typography variant="body2" color="text.secondary">
                  {selectedBooking.booking_code} - {selectedBooking.court_name}
                </Typography>
              )}
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'grid', gap: 3, mt: 1 }}>
              ...
              <Paper sx={{ p: 2, bgcolor: 'grey.50' }}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                  <Typography variant="body2">
                    <strong>Khách hàng:</strong> {selectedBooking.customer_name}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Sân:</strong> {selectedBooking.court_name}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Ngày:</strong>{' '}
                    {format(parseISO(selectedBooking.booking_date), 'dd/MM/yyyy')}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Thời gian:</strong> {selectedBooking.start_time} -{' '}
            ...
            {selectedBooking?.payment_status && (
              <Alert
                ...
                icon={
                  selectedBooking.payment_status === 'paid' ? <CheckCircleIcon /> : <WarningIcon />
                }
              >
                <Typography variant="body2">
                  Trạng thái hiện tại:{' '}
                  ...
                  {selectedBooking.transaction && (
                    <>
                      ...
                      <br />
                      Ngày thanh toán:{' '}
                      {format(parseISO(selectedBooking.transaction.transaction_date), 'dd/MM/yyyy')}
                    </>
                  )}
                </Typography>
              </Alert>
